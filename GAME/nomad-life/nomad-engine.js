...
const cam={x:0,z:-12,y:9,zoom:62,rot:0},player={x:0,z:-7,tx:0,tz:-7,rot:0,name:'Mon Nomade',shirt:'#567f91',hair:'#3b2d28',style:0,body:1,face:1};let money=100000,clock=8,t=0,started=false,working=false,lastPayClock=8,buildMode=false,tool='room',selected=null,ghost=null,roomStart=null,worldKey='TERRE';const objects=[];const pointers=new Map();let gesture=null;
...
function world(){ground();house(-18,18,C.house[0]);house(18,18,C.house[1]);house(-18,42,C.house[2]);house(18,42,C.house[3]);box(0,55,12,5,8,'#d7d2c5');box(0,55,13,.25,9.2,C.roof,Math.PI/4);for(let z=-45;z<=65;z+=10){tree(-12,z+(z%20?2:-2));tree(12,z+(z%20?-2:2))}person(-3,8,'#9a6657');person(4,15,'#6d8a62');person(-4,28,'#806b9a');person(3,38,'#a77a4f');humanoid(1.35,-2.4)}
